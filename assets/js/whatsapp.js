...
$form.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let message = 'send?phone=' + phone + '&text=*_SOLICITUD DE BUSQUEDAD DE VEHÍCULOS_*%0A*(Datos del Solicitante)*%0A%0A*¿Nombre Del Solicitante?*%0A' 
        + Nombre + '%0A*¿Celular de Contacto?*%0A' + Celular + '%0A*¿Zona de Trabajo?*%0A' + Zona + '%0A*¿Direccion del Trabajo?*%0A' + Direccion + 
        '%0A*¿Tipo de Vehículo?*%0A' + Servicio1 +' *:* ' + Servicio2 + '%0A*¿Cantidad de Vehículos?*%0A' + Cantidad +
